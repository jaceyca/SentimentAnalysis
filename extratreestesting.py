...
def main():
    ...
    etclf = ExtraTreesClassifier(n_estimators=bestn,
    ...
    etsubmission = make_predictions(etclf, X_train_n, y_train, X_test_n)
    save_data(etsubmission, "extratreessubmission.txt")
